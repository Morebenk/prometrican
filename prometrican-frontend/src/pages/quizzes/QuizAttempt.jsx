...
import { flagQuestion } from "../../store/slices/flagSlice";
...
const QuizAttempt = () => {
  ...
  const { currentQuiz, currentAttempt, loading } = useSelector((state) => state.quiz);
  ...
  return (
    <Box>
      ...
      <LinearProgress 
        variant="determinate" 
        value={(currentQuestionIndex + 1) * 100 / currentQuiz.questions.length} 
        sx={{ mb: 3 }}
      />
          ...
          <Box display="flex" justifyContent="space-between" alignItems="flex-start">
            ...
            <Box>
              <IconButton onClick={handleBookmark}>
                <BookmarkIcon color={currentQuestion.isBookmarked ? "primary" : "inherit"} />
              </IconButton>
              <IconButton onClick={() => setShowFlagDialog(true)}>
                <FlagIcon color={currentQuestion.isFlagged ? "error" : "inherit"} />
              </IconButton>
            </Box>
          </Box>
